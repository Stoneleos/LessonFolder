...
canvas_free = Canvas(legend_frame, width=20, height=20)
canvas_free.pack(side="left", padx=5)
canvas_free.create_rectangle(0, 0, 20, 20, fill="green")
Label(legend_frame, text="Свободно").pack(side="left", padx=5)

canvas_booked = Canvas(legend_frame, width=20, height=20)
canvas_booked.pack(side="left", padx=5)
canvas_booked.create_rectangle(0, 0, 20, 20, fill="red")
Label(legend_frame, text="Забронировано").pack(side="left", padx=5)
